...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "spikerbooking_production"

  config.action_mailer.perform_caching = false
  config.action_mailer.default_url_options = { host: 'https://spikerbooking-dev.herokuapp.com/' }
  ...
  # To send Mailers in production Enviroment
