...
ActiveRecord::Schema.define(version: 2022_04_29_052052) do
  ...
  create_table "artist_profiles", force: :cascade do |t|
    ...
    t.boolean "hidden"
    t.text "twitter_url"
    t.text "apple_music_url"
    t.text "tidal_url"
    t.index ["hidden"], name: "index_artist_profiles_on_hidden"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["current_type"], name: "index_users_on_current_type"
  ...
  create_table "venue_profiles", force: :cascade do |t|
    ...
    t.text "zip_code"
    t.boolean "hidden"
    t.index ["hidden"], name: "index_venue_profiles_on_hidden"
  ...
  add_foreign_key "venue_profiles", "users"
end
